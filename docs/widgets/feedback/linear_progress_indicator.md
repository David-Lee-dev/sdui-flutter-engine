...
Shows determinate or indeterminate linear progress. This primitive mirrors the corresponding Flutter widget described by its implementation.
...
| `min_height` | `size` | — | `null` | Yes | minimum track height. |
