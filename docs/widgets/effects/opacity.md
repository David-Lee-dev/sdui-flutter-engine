...
Builds Flutter's [Opacity] with a value clamped to Flutter's valid range. This primitive mirrors the corresponding Flutter widget described by its implementation.

## Properties

| Name | Type | Allowed values | Default | Bindable (`${}`) | Description |
| --- | --- | --- | --- | --- | --- |
| `opacity` | `ratio01` | — | `1.0` | Yes | alpha applied to the child (0 invisible, 1 opaque). |
