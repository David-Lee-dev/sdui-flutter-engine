...
Builds Flutter's [Transform] from a resolved matrix and alignment. This primitive mirrors the corresponding Flutter widget described by its implementation.
