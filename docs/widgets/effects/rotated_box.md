...
Builds Flutter's [RotatedBox] for a `rotatedBox` node. This primitive mirrors the corresponding Flutter widget described by its implementation.

## Properties

| Name | Type | Allowed values | Default | Bindable (`${}`) | Description |
| --- | --- | --- | --- | --- | --- |
| `quarter_turns` | `integer` | — | `0` | Yes | rotates the child by this many clockwise quarter turns. |
