...
Applies a blur filter to its child's painted output. This primitive mirrors the corresponding Flutter widget described by its implementation.
...
| `enabled` | `flag` | — | `true` | Yes | whether the filter is applied. |
