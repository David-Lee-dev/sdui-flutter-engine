...
Builds a stateful [PageView] and dispatches page indices as event data. This primitive mirrors the corresponding Flutter widget described by its implementation.

## Properties

| Name | Type | Allowed values | Default | Bindable (`${}`) | Description |
| --- | --- | --- | --- | --- | --- |
| `on_page_changed` | `text` | — | `null` | Yes | action dispatched with the new page index. |
