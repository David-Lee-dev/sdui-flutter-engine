...
Builds a [RefreshIndicator] that awaits the configured engine action. This primitive mirrors the corresponding Flutter widget described by its implementation.

## Properties

| Name | Type | Allowed values | Default | Bindable (`${}`) | Description |
| --- | --- | --- | --- | --- | --- |
| `on_refresh` | `text` | — | `null` | Yes | action awaited during refresh. |
