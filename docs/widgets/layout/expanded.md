...
Builds Flutter's [Expanded], supplying an empty child when required. This primitive mirrors the corresponding Flutter widget described by its implementation.
