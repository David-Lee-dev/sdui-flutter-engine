...
Builds [SizedOverflowBox] from separate width and height props. This primitive mirrors the corresponding Flutter widget described by its implementation.

## Properties

| Name | Type | Allowed values | Default | Bindable (`${}`) | Description |
| --- | --- | --- | --- | --- | --- |
| `width` | `size` (scaled by EngineMetrics) | — | `0` | Yes | sets the box width. |
| `height` | `size` (scaled by EngineMetrics) | — | `0` | Yes | sets the box height. |
