...
Builds Flutter's [ListBody] from the node's children. This primitive mirrors the corresponding Flutter widget described by its implementation.

## Properties

| Name | Type | Allowed values | Default | Bindable (`${}`) | Description |
| --- | --- | --- | --- | --- | --- |
| `main_axis` | `axis` | horizontal, vertical | `vertical` | Yes | axis along which children are laid out. Values: horizontal \| vertical. |
