...
Builds a controlled Flutter [Checkbox] from the bound engine value. This primitive mirrors the corresponding Flutter widget described by its implementation.
...
| `check_color` | `color` | — | `null` | Yes | color of the checkbox check mark. |
| `shape` | `outlinedBorder` | — | `null` | Yes | outline shape of the checkbox. |
